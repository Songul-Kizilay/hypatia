...
This directory is the source of truth for Hypatia's product intent and technical design. Documents are written before implementation so that choices remain reviewable and the system can grow without losing its purpose.
