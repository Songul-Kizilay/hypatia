...
Each module document will state its purpose, user value, boundaries, permissions, inputs/outputs, risks, and acceptance criteria before implementation begins.

## Initial module map

| Module | Status | Design focus |
| --- | --- | --- |
...
| [Research](Research.md) | Partial | Explicit HTTPS acquisition, persistent run lifecycle, and user-selected evidence; discovery/synthesis planned. |
